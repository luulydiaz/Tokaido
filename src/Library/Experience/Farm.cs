...
namespace Tokaido
{
    public class Farm: AbstractExperience
    {
        /* 
            ...
            Farm usa el patron Observer y por lo tanto es un observador y el metodo PositionChange
            recibe actualizaciones cuando cambia de posicion el viajero.
            PositionChange tambien es Polimorfica y por lo tanto Farm la define segun sus necesidades
        ...
        */
        ...
        public Farm(string name,int limit, int position, int coins): base(name,limit, position)
        {
            Coins = coins;
        }
